        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-lg-12 col-md-6 d-flex flex-column align-items-center justify-content-center">
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="pt-4 pb-2">
                            <h5 class="card-title text-center pb-0 fs-4 font-weight-bold">Add New Books Borrower</h5>
                        </div>
                        <form class="row g-3 needs-validation" action="" method="post" novalidate>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="datestart" class="form-control" id="datestart" placeholder="yyyy-mm-dd" required>
                                <div class="invalid-feedback">Please enter your Date!</div>
                            </div>
                            <div class="col-12">
                                <label for="buku" class="form-label">Buku</label>
                                <div class="input-group has-validation">
                                    <input type="text" name="buku" class="form-control" id="buku" required>
                                    <div class="invalid-feedback">Please enter your username.</div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    <input type="text" name="dateend" class="form-control" id="dateend" placeholder="yyyy-mm-dd" required>
                                    <div class="invalid-feedback">Please enter your username.</div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <button class="btn w-100" type="submit" name="add" style="background-color: #52784F; color: white;">Create New Borrower</button>
                            </div>
                        </form>
                        <div class="col-12">

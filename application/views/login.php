        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="pt-4 pb-2">
                            <h5 class="card-title text-center pb-0 fs-4 font-weight-bold">Login to Your Account</h5>
                        ...
                        <form class="row g-3 needs-validation" action="" method="POST" novalidate>
                            ...
                            <div class="col-12">
                                <button class="btn w-100" type="submit" name="login" style="background-color: #52784F; color: white;">Login</button>
                            </div>
                        </form>
                        <div class="col-12">
                            <p class="small mb-0">Don't have account? <a href="<?= base_url('perpuskita/signup') ?>">Create an account</a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-8-md-6 d-flex flex-column align-items-center justify-content-center">
                <img src="<?= base_url('assets/img/login-img.png'); ?>">
            </div>
        </div>
    </div>
</section>